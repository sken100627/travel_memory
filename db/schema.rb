...
ActiveRecord::Schema[7.0].define(version: 2023_11_10_052958) do
  ...
  create_table "departures", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "records", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["destination_id"], name: "index_records_on_destination_id"
